...
VALUES ('음식 월드컵', '맛있는 음식을 가려보자', 1, 1, 19, now());
INSERT INTO worldcup_tb (title, description, visibility, user_id, games_completed, created_at)
...
INSERT INTO worldcup_item_tb (CHAMPION_COUNT, TOTAL_COUNT, WIN_COUNT, WORLDCUP_ID, IMG_URL, ITEMNAME)
VALUES (0, 6, 3, 1, '/img/1.png', '짜장면'),
       (0, 4, 1, 1, '/img/2.png', '탕수육'),
       (0, 7, 4, 1, '/img/3.png', '짬뽕'),
       (0, 5, 2, 1, '/img/4.png', '스시'),
       (0, 5, 2, 1, '/img/5.png', '회'),
       (0, 4, 1, 1, '/img/6.png', '비빔밥'),
       (0, 6, 3, 1, '/img/7.png', '불고기'),
       (0, 7, 4, 1, '/img/8.png', '닭가슴살 샐러드'),
       (0, 4, 1, 1, '/img/9.png', '탄탄면'),
       (0, 5, 2, 1, '/img/10.png', '카이막'),
       (0, 4, 1, 1, '/img/11.png', '스테이크'),
       (0, 5, 3, 1, '/img/12.png', '수르스트뢰밍'),
       (0, 4, 1, 1, '/img/13.png', '피시앤칩스'),
       (0, 5, 2, 1, '/img/14.png', '장어젤리'),
       (0, 6, 3, 1, '/img/15.png', '알밥'),
       (1, 6, 5, 1, '/img/16.png', '돼지국밥'),
       (0, 1, 0, 1, '/img/17.png', '국수'),
       (0, 5, 2, 1, '/img/18.png', '밀면'),
       (0, 2, 0, 1, '/img/19.png', '냉면'),
       (1, 7, 5, 1, '/img/20.png', '돈까스'),
       (0, 2, 0, 1, '/img/21.png', '규카츠'),
       (0, 4, 1, 1, '/img/22.png', '텐동'),
       (0, 3, 1, 1, '/img/23.png', '햄버거'),
       (0, 5, 2, 1, '/img/24.png', '치킨'),
       (0, 6, 4, 1, '/img/25.png', '피자'),
       (0, 3, 1, 1, '/img/26.png', '샌드위치'),
       (1, 11, 9, 1, '/img/27.png', '오므라이스'),
       (0, 3, 1, 1, '/img/28.png', '김밥'),
       (0, 5, 2, 1, '/img/29.png', '순대'),
       (0, 5, 3, 1, '/img/30.png', '튀김'),
       (0, 6, 1, 1, '/img/31.png', '오향장육'),
       (0, 3, 1, 1, '/img/32.png', '취두부'),
       (0, 4, 1, 1, '/img/33.png', '계란빵'),
       (8, 13, 10, 1, '/img/34.png', '붕어빵'),
       (6, 9, 6, 1, '/img/35.png', '호빵'),
       (2, 6, 5, 1, '/img/36.png', '초코파이');


INSERT INTO worldcup_item_tb (itemname, img_url, worldcup_id)
VALUES ('루피', '/img/37.png', 2),
       ('조로', '/img/38.png', 2),
       ('상디', '/img/39.png', 2),
       ('쵸파', '/img/40.png', 2),
       ('나미', '/img/41.png', 2),
...
INSERT INTO worldcup_item_tb (itemname, img_url, worldcup_id)
VALUES ('어벤져스: 엔드게임', '/img/166.png', 9),
...
INSERT INTO worldcup_item_tb (itemname, img_url, worldcup_id)
VALUES ('계란후라이(펜케이크 아님)', '/img/217.png', 12),
